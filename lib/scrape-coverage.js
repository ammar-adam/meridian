...
export function coverageModeHint(level) {
  if (level === 'good') return 'Auto will use Instant (~25–40s) — rich site copy detected.'
  if (level === 'medium') return 'Auto will use Quick research — limited public copy on site.'
  return 'Auto will use Quick research — consider Deep for thin sites.'
}
