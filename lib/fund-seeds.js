import { addFund, ensureActiveFund, getAllFunds, setActiveFundId } from '@/lib/fund-profile'
...
export function seedFundProfilesIfEmpty() {
  ...
  // Always leave Panache active when profiles exist (first visit or recovered empty activeId).
