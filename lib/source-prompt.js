...
- Fully enriched incubator seeds (personName + domain + Velocity/DMZ/CDL provenance) should score 80-95 when the thesis is Canada / Waterloo / Toronto / pre-seed — put them near the top
- Thin incubator rows (name only) and domain_registry rows stay exploratory (45-59) unless thesis keywords strongly match
- Preserve personName when present (founder names from cohort lists)
