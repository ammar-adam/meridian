...
function localEcosystemCompanies(school) {
...
export async function runSchoolScout(schoolId, { queries = 1 } = {}) {
  ...
  if (scoutEnabled()) {
    const q = [
      `List 8 early-stage startups from ${school.name} (students, alumni, or campus incubators). Format each line exactly as: Name | domain.com | one-line description. Prefer pre-seed and seed.`,
    ]
