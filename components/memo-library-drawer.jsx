              ...
              {library.map(entry => (
                <li key={entry.id}>
                  <button
                    ...
                    className="group w-full rounded-xl border border-[color:var(--m-border)] bg-[color:var(--m-surface-2)] p-4 text-left transition hover:border-white/20 hover:bg-[color:var(--m-surface-3)] hover:shadow-card"
                  >
