      ...
      {data?.enabled && (
        <>
          ...
          {accruing ? (
            ...
            <div className="mt-6 rounded-xl border border-[color:var(--m-accent-line)] bg-[color:var(--m-accent-soft)] px-4 py-4 text-[14px] leading-relaxed text-[color:var(--m-accent)]">
