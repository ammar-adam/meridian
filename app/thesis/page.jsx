          ...
          <>
            {statInsight && (
              <div className="m-card m-card-pad mb-6 border-[color:var(--m-accent-line)] bg-[color:var(--m-accent-soft)]">
                ...
                <p className="text-[13px] leading-relaxed text-[color:var(--m-accent)]">{statInsight.message}</p>
                <Link href="/fund" className="mt-2 inline-block text-[12px] font-medium text-[color:var(--m-accent)] hover:underline">
            ...
            {learning && (
              <div className="m-card m-card-pad mb-6 border-[color:var(--m-accent-line)] bg-[color:var(--m-accent-soft)]">
                ...
                <p className="mt-1 text-[12px] text-[color:var(--m-accent)]">
                ...
                <Link href="/brief" className="mt-3 inline-block text-[12px] font-medium text-[color:var(--m-accent)] hover:underline">
                  ...
                  <table className="m-table !min-w-0">
                    ...
                    <tbody>
                      {summary.outcomes.map(o => (
                        <tr key={o.id}>
                          <td>{o.companyName}</td>
                          <td className={o.newValue === 'pursue' ? 'font-medium text-[color:var(--m-accent)]' : ''} style={o.newValue !== 'pursue' ? { color: 'var(--m-muted)' } : undefined}>{o.newValue}</td>
